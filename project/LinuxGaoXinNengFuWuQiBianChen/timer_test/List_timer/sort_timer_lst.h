#ifndef _SORT_TIMER_LST_H_
#define _SORT_TIMER_LST_H_
...
class sort_timer_lst {
    public:
        ...
        void add_timer(util_timer *timer) 
        {
             ...
             * 重载函数add_timer(util_timer *timer, util_timer *lst_head)，
        ...
        void adjust_timer(util_timer *timer) 
        {
            ...
            /*
             * 如果被调整的目标定时器处在链表尾部，或者该定时器新的超时值仍小于
             * 其下一个定时器的超时值，则不用调整。
             * */
        ...
        void del_timer(util_timer *timer)
        {
            ...
            /*
             * 如果链表中至少有两个定时器，且目标定时器是链表的头节点，则将
             * 链表的头节点重置为原头节点的下一个节点，然后删除目标定时器。
             * */
            if (timer == head) {
                head = head->next;
                head->prev = NULL;
